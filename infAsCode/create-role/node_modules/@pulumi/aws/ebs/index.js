...
// Export members:
__exportStar(require("./defaultKmsKey"), exports);
__exportStar(require("./encryptionByDefault"), exports);
__exportStar(require("./getDefaultKmsKey"), exports);
__exportStar(require("./getEbsVolumes"), exports);
__exportStar(require("./getEncryptionByDefault"), exports);
__exportStar(require("./getSnapshot"), exports);
__exportStar(require("./getSnapshotIds"), exports);
__exportStar(require("./getVolume"), exports);
__exportStar(require("./snapshot"), exports);
__exportStar(require("./snapshotCopy"), exports);
__exportStar(require("./snapshotImport"), exports);
__exportStar(require("./volume"), exports);
// Import resources to register:
const defaultKmsKey_1 = require("./defaultKmsKey");
const encryptionByDefault_1 = require("./encryptionByDefault");
const snapshot_1 = require("./snapshot");
const snapshotCopy_1 = require("./snapshotCopy");
const snapshotImport_1 = require("./snapshotImport");
    ...
    construct: (name, type, urn) => {
        switch (type) {
            case "aws:ebs/defaultKmsKey:DefaultKmsKey":
                return new defaultKmsKey_1.DefaultKmsKey(name, undefined, { urn });
            case "aws:ebs/encryptionByDefault:EncryptionByDefault":
                return new encryptionByDefault_1.EncryptionByDefault(name, undefined, { urn });
            case "aws:ebs/snapshot:Snapshot":
                return new snapshot_1.Snapshot(name, undefined, { urn });
            case "aws:ebs/snapshotCopy:SnapshotCopy":
                return new snapshotCopy_1.SnapshotCopy(name, undefined, { urn });
            case "aws:ebs/snapshotImport:SnapshotImport":
                return new snapshotImport_1.SnapshotImport(name, undefined, { urn });
