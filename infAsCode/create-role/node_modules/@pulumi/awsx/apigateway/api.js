...
class API extends pulumi.ComponentResource {
    constructor(name, args, opts = {}) {
        ...
        const version = pulumi.all([this.restAPI.apiKeySource, this.restAPI.binaryMediaTypes, this.restAPI.endpointConfiguration, this.restAPI.minimumCompressionSize, this.restAPI.policy, swaggerString])
